functions {
  vector coupled_seir(real t, vector y_flat, array[] real N, array[] real beta, 
                      array[] real sigma, array[] real gamma,
                      array[] real kappa, array[] real g, 
                      array[,] real m, array[,] real r) {
    int n = size(N);
